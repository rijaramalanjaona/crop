...
public class GrayColorTest {
	...
	public static void main(String[] args) {
		System.out.println("------------------ GrayColorTest -----------------");
		System.out
		...
		try {
			...
			resultatGetGrayscale = new GrayColor(image.getRGB(1750, 800)).getGrayscale();
			System.out.println("resultatGetGrayscale 1 : " + resultatGetGrayscale);

			resultatGetGrayscale = new GrayColor(image.getRGB(0, 450)).getGrayscale();
			System.out.println("resultatGetGrayscale 2 : " + resultatGetGrayscale);
