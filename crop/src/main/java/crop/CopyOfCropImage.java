...
public class CopyOfCropImage {
	...
	BufferedImage avg_gray = new BufferedImage(original.getWidth(),
	...
	rr = rr.createWritableChild(0, 0, image.getWidth(), image.getHeight(),
		0, 0, null);
	...
	// bi = convertToGray(bi);
	// bi = avg(bi);
	File output = new File(squareFile.getParent().replace("\\bin\\",
		"\\src\\")
		+ "/Trimmed.png");
