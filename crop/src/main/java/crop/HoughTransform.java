...
public class HoughTransform {
	...
	BufferedImage outputImage = new BufferedImage(arrayData.width,
		arrayData.height, BufferedImage.TYPE_INT_ARGB);
	...
	ArrayData inputData = getArrayDataFromImage("C:\\projetCrop\\outputScaledPngFile.png");
	int minContrast = 100;
	ArrayData outputData = houghTransform(inputData, 640, 480, minContrast);
	writeOutputImage("C:\\projetCrop\\outputHoughFile.png", outputData);
	return;
    }
}