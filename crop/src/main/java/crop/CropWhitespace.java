...
public class CropWhitespace {
	...
	try {
	    ImageIO.write(image, "png", new File(
		    "C:\\projetCrop\\outputPng\\apresCreateGrayTotals.png"));
	} catch (IOException e) {
     ...
     */
    private void findRectangleCoorinatesOld() {
	System.out.println("marginTop : " + marginTop + " marginBottom : "
	...
	System.out.println(">>> grayToleranceWidth : " + grayToleranceWidth);
	System.out.println(">>> xTop : " + xTop + " xBottom : " + xBottom);
	System.out.println(">>> xGrayTotals[xTop] : " + xGrayTotals[xTop]);
    }
	...
	if (xTop == Integer.MAX_VALUE || yLeft == Integer.MAX_VALUE) {
	    System.out.println("Unable to crop image...");
	    // solution contournement pbm image collée au bord de la page
	    image = CopyOfCropImage.trimWhite(image);
	    System.out.println("Use CopyOfCropImage.trimWhite(image)");
	    return image;
	    ...
	    // rr = rr.createWritableChild(xTop, yLeft, newWidth, newHeight, 0,
	    // 0,
	    // null);
