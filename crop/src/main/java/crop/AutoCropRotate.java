...
public class AutoCropRotate {
	...
	private void init() throws Exception {
		...
		outputScaledPngFile = new File("C:\\projetCrop\\outputScaledPngFile.png");
	...
	private void go() throws Exception {
		...
		try {
			...
			image = cropper.crop(image); // TODO testé ok jusqu'ici

			// TODO a revoir
			AngleDetector angler = new AngleDetector();
			double angle = angler.getRotation(image);
			System.out.println("angle a revoir = " + angle);
